...
function LiveWallpaper() {
  ...
  <i className="fas fa-search"></i> 
        ...
        <Link to={'/explore'}>
                ...
                <div className="live-wallpaper-section">
                      <video src="/img/LiveWallpaper.mp4" autoPlay controls loop className="live-wallpaper-wallpaper"></video>
                    <h1>Live Wallpaper be added <span>Soon</span> </h1>
                </div>
            </div>
            </div>
            </div>
